...
describe('Admin API (e2e)', () => {
  ...
  describe('Admin Profile', () => {
    it('GET /api/admin/profile - 관리자 프로필 조회 성공', () => {
      if (!adminToken) {
    ...
    it('GET /api/admin/profile - 권한 없는 사용자 접근 실패', () => {
      return request(app.getHttpServer())
        .get('/api/admin/profile')
  ...
  describe('Breeder Verification Management', () => {
    it('GET /api/admin/verification/pending - 승인 대기 브리더 목록', () => {
      if (!adminToken) {
        console.log('Admin token not available, skipping test');
        return;
      }
    ...
    it('PUT /api/admin/verification/:breederId - 브리더 승인', () => {
      if (!adminToken) {
        console.log('Admin token not available, skipping test');
        return;
      }
    ...
    it('PUT /api/admin/verification/:breederId - 브리더 거절', () => {
      if (!adminToken) {
        console.log('Admin token not available, skipping test');
        return;
      }
  ...
  describe('User Management', () => {
    it('GET /api/admin/users - 사용자 목록 조회', () => {
      if (!adminToken) {
        console.log('Admin token not available, skipping test');
        return;
      }
    ...
    it('PUT /api/admin/users/:userId/status - 사용자 상태 변경', () => {
      if (!adminToken) {
        console.log('Admin token not available, skipping test');
        return;
      }
    ...
    it('GET /api/admin/users - 브리더만 필터링', () => {
      if (!adminToken) {
        console.log('Admin token not available, skipping test');
        return;
      }
  ...
  describe('Application Monitoring', () => {
    it('GET /api/admin/applications - 입양 신청 모니터링', () => {
      if (!adminToken) {
        console.log('Admin token not available, skipping test');
        return;
      }
    ...
    it('GET /api/admin/applications - 특정 브리더 신청 조회', () => {
      if (!adminToken) {
        console.log('Admin token not available, skipping test');
        return;
      }
  ...
  describe('Report Management', () => {
    it('GET /api/admin/reports - 신고 목록 조회', () => {
      if (!adminToken) {
        console.log('Admin token not available, skipping test');
        return;
      }
    ...
    it('PUT /api/admin/reports/:breederId/:reportId - 신고 처리', () => {
      if (!adminToken) {
        console.log('Admin token not available, skipping test');
        return;
      }
    ...
    it('DELETE /api/admin/reviews/:breederId/:reviewId - 부적절한 후기 삭제', () => {
      if (!adminToken) {
        console.log('Admin token not available, skipping test');
        return;
      }
  ...
  describe('Statistics', () => {
    it('GET /api/admin/stats - 전체 통계 조회', () => {
      if (!adminToken) {
        console.log('Admin token not available, skipping test');
        return;
      }
    ...
    it('GET /api/admin/stats - 기간별 통계 조회', () => {
      if (!adminToken) {
        console.log('Admin token not available, skipping test');
        return;
      }
