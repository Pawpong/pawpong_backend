...
import { InquiryCreateRequestDto } from '../../dto/request/inquiry-create-request.dto';
...
export class CreateInquiryUseCase {
    ...
    async execute(userId: string, dto: InquiryCreateRequestDto): Promise<{ inquiryId: string }> {
