...
import { POPULAR_KEYWORD_ADMIN_READER_PORT } from '../../admin/popular-keyword/application/ports/popular-keyword-admin-reader.port';
import { POPULAR_KEYWORD_WRITER_PORT } from '../../admin/popular-keyword/application/ports/popular-keyword-writer.port';
import { CreatePopularKeywordUseCase } from '../../admin/popular-keyword/application/use-cases/create-popular-keyword.use-case';
import { DeletePopularKeywordUseCase } from '../../admin/popular-keyword/application/use-cases/delete-popular-keyword.use-case';
import { GetAllPopularKeywordsAdminUseCase } from '../../admin/popular-keyword/application/use-cases/get-all-popular-keywords-admin.use-case';
import { GetPopularKeywordByIdUseCase } from '../../admin/popular-keyword/application/use-cases/get-popular-keyword-by-id.use-case';
import { UpdatePopularKeywordUseCase } from '../../admin/popular-keyword/application/use-cases/update-popular-keyword.use-case';
import { PopularKeywordAdminMongooseReaderAdapter } from '../../admin/popular-keyword/infrastructure/popular-keyword-admin-mongoose-reader.adapter';
import { PopularKeywordMongooseWriterAdapter } from '../../admin/popular-keyword/infrastructure/popular-keyword-mongoose-writer.adapter';
import { PopularKeywordAdminCommandController } from '../../admin/popular-keyword/controller/popular-keyword-admin-command.controller';
import { PopularKeywordAdminQueryController } from '../../admin/popular-keyword/controller/popular-keyword-admin-query.controller';
