...
import { DistrictAdminCommandController } from '../../admin/district/controller/district-admin-command.controller';
import { DistrictAdminQueryController } from '../../admin/district/controller/district-admin-query.controller';
import { DISTRICT_ADMIN_READER_PORT } from '../../admin/district/application/ports/district-admin-reader.port';
import { DISTRICT_WRITER_PORT } from '../../admin/district/application/ports/district-writer.port';
import { CreateDistrictUseCase } from '../../admin/district/application/use-cases/create-district.use-case';
import { DeleteDistrictUseCase } from '../../admin/district/application/use-cases/delete-district.use-case';
import { GetAllDistrictsAdminUseCase } from '../../admin/district/application/use-cases/get-all-districts-admin.use-case';
import { GetDistrictByIdAdminUseCase } from '../../admin/district/application/use-cases/get-district-by-id-admin.use-case';
import { UpdateDistrictUseCase } from '../../admin/district/application/use-cases/update-district.use-case';
import { DistrictMongooseAdminReaderAdapter } from '../../admin/district/infrastructure/district-mongoose-admin-reader.adapter';
import { DistrictMongooseWriterAdapter } from '../../admin/district/infrastructure/district-mongoose-writer.adapter';
