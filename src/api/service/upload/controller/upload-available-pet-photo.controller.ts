import { Body, HttpCode, HttpStatus, Param, Post, UploadedFiles, UseInterceptors } from '@nestjs/common';
...
import { ApiUploadAvailablePetPhotosEndpoint } from '../swagger/index';
