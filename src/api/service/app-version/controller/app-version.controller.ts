...
import { ApiAppVersionController, ApiCheckAppVersionEndpoint } from '../swagger/index';
...
export class AppVersionController {
    ...
    async checkVersion(
        ...
        return ApiResponseDto.success(result, APP_VERSION_RESPONSE_MESSAGE_EXAMPLES.versionChecked);
    }
}
