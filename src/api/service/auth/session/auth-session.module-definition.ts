...
import { AuthReactivateAccountController } from '../controller/auth-reactivate-account.controller';
...
// 인증 > 세션 슬라이스 (토큰 재발급, 로그아웃, 탈퇴 계정 복구)
export const AUTH_SESSION_MODULE_IMPORTS = [AuthSharedModule];

export const AUTH_SESSION_MODULE_CONTROLLERS = [
    AuthRefreshTokenController,
    AuthLogoutController,
    AuthReactivateAccountController,
];
...
export const AUTH_SESSION_MODULE_PROVIDERS = [
    ...
    AuthAccountReactivationPolicyService,
    AuthSessionAdapter,
    {
