...
import { buildAuthBreederDocumentsUploadMessage } from '../constants/auth-response-messages';
...
import { ApiUploadBreederDocumentsEndpoint } from '../swagger/index';

@AuthPublicController()
export class AuthBreederDocumentsUploadController {
    constructor(private readonly uploadAuthBreederDocumentsUseCase: UploadAuthBreederDocumentsUseCase) {}
