...
import { ApiKakaoCallbackEndpoint, ApiKakaoLoginEndpoint } from '../swagger/index';
...
export class AuthKakaoLoginController {
    ...
    kakaoLogin(
        ...
        return this.getSocialLoginRedirectUrlUseCase.execute('kakao', referer, origin, returnUrl);
    }
    ...
    async kakaoCallback(@Req() req: Request & { user: AuthSocialCallbackProfile }) {
