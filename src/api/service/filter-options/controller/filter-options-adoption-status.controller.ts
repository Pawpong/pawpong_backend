...
import { ApiGetAdoptionStatusEndpoint } from '../swagger/index';
...
export class FilterOptionsAdoptionStatusController {
    ...
    async getAdoptionStatus(): Promise<ApiResponseDto<AdoptionStatusOptionDto[]>> {
        ...
        return ApiResponseDto.success(result, FILTER_OPTIONS_RESPONSE_MESSAGE_EXAMPLES.adoptionStatusRetrieved);
    }
}
