...
describe('지역 관리자 종단간 테스트', () => {
    ...
    describe('지역 생성', () => {
        ...
        it('중복된 city로 생성 실패', async () => {
            if (!adminToken || !createdDistrictId) {
                console.log('주의: 관리자 토큰 또는 생성된 지역 ID가 없어서 테스트 스킵');
                return;
            }
