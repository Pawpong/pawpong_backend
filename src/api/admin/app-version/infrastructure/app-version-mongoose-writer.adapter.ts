...
} from '../application/types/app-version-command.type';
import { AppVersionRepository } from '../../../service/app-version/repository/app-version.repository';
...
export class AppVersionMongooseWriterAdapter implements AppVersionWriterPort {
    ...
    async update(appVersionId: string, updateData: AppVersionUpdateCommand): Promise<AppVersionAdminSnapshot | null> {
