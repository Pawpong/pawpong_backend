...
import { HOME_RESPONSE_MESSAGE_EXAMPLES } from '../../../service/home/constants/home-response-messages';
import { HomeAdminProtectedController } from '../decorator/home-admin-controller.decorator';
import { FaqResponseDto } from '../../../service/home/dto/response/faq-response.dto';
import { ApiGetAllFaqsAdminEndpoint } from '../swagger/index';
...
export class HomeAdminFaqsQueryController {
    ...
    async getAllFaqs(): Promise<ApiResponseDto<FaqResponseDto[]>> {
        ...
        return ApiResponseDto.success(faqs, HOME_RESPONSE_MESSAGE_EXAMPLES.faqsRetrieved);
    }
}
