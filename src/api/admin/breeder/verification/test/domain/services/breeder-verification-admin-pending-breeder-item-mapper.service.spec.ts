...
import type { BreederVerificationAdminBreederSnapshot } from '../../../application/ports/breeder-verification-admin-reader.port';
...
describe('브리더 인증 관리자 승인 대기 항목 매퍼', () => {
    it('승인 대기 브리더 응답 계약을 유지한다', () => {
        ...
        const breeder: BreederVerificationAdminBreederSnapshot = {
            id: 'breeder-2',
            nickname: '대기브리더',
        ...
        expect(service.toResponse(breeder)).toMatchObject({
            breederId: 'breeder-2',
            breederName: '대기브리더',
            verificationInfo: {
