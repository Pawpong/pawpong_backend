...
import { AnnouncementResponseDto } from '../../../service/announcement/dto/response/announcement-response.dto';
import { ApiGetAllAnnouncementsAdminEndpoint } from '../swagger/index';
