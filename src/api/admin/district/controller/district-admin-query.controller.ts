...
import type { DistrictAdminResult } from '../../../service/district/application/types/district-result.type';
import { DistrictAdminProtectedController } from '../decorator/district-admin-controller.decorator';
import { DistrictResponseDto } from '../../../service/district/dto/response/district-response.dto';
import { ApiGetAllDistrictsAdminEndpoint, ApiGetDistrictByIdAdminEndpoint } from '../swagger/index';
