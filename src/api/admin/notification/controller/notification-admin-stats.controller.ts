...
import { NOTIFICATION_RESPONSE_MESSAGE_EXAMPLES } from '../../../service/notification/constants/notification-response-messages';
...
import { ApiGetNotificationAdminStatsEndpoint } from '../swagger/index';
...
export class NotificationAdminStatsController {
    ...
    async getStats(@CurrentUser('userId') userId: string): Promise<ApiResponseDto<NotificationStatsResponseDto>> {
        ...
        return ApiResponseDto.success(result, NOTIFICATION_RESPONSE_MESSAGE_EXAMPLES.notificationStatsRetrieved);
    }
}
