...
@Injectable()
export class BreederPublicReviewPageAssemblerService {
    constructor(private readonly breederPaginationAssemblerService: BreederPaginationAssemblerService) {}

    build(reviews: BreederPublicReviewRecord[], total: number, page: number, limit: number): BreederReviewPageResult {
