...
import type { BreederSearchPageResult } from '../types/breeder-result.type';
...
export class SearchBreedersUseCase {
    ...
    async execute(searchDto: BreederSearchQuery): Promise<BreederSearchPageResult> {
        ...
        return this.breederPaginationAssemblerService.build(items, page, limit, result.total);
    }
}
