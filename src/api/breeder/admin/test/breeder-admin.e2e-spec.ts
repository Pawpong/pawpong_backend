...
/**
 * Breeder Admin API E2E 테스트
 * 브리더 관리 (정지/활성화/테스트계정 - 관리자 전용)
 */
describe('Breeder Admin API E2E Tests', () => {
    ...
    describe('POST /api/breeder-admin/suspend/:breederId', () => {
    ...
    describe('POST /api/breeder-admin/unsuspend/:breederId', () => {
    ...
    describe('PATCH /api/breeder-admin/test-account/:breederId', () => {
