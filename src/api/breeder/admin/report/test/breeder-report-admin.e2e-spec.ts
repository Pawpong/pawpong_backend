...
/**
 * Breeder Report Admin API E2E 테스트
 * 브리더 신고 처리 (관리자 전용)
 */
describe('Breeder Report Admin API E2E Tests', () => {
    ...
    describe('GET /api/breeder-report-admin/reports', () => {
    ...
    describe('PATCH /api/breeder-report-admin/reports/:reportId', () => {
