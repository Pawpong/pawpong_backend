...
export function ApiGetPopularBreedersEndpoint() {
    return ApiEndpoint({
        ...
        isPublic: true,
        successDescription: '인기 브리더 목록 조회 성공',
...
export function ApiGetBreederReviewsEndpoint() {
    return applyDecorators(
        ApiPaginatedEndpoint({
            ...
            isPublic: true,
            supportsOptionalAuth: true,
            successDescription: '브리더 후기 목록 조회 성공',
...
export function ApiGetBreederPetsEndpoint() {
    return applyDecorators(
        ApiPaginatedEndpoint({
            ...
            isPublic: true,
            supportsOptionalAuth: true,
            successDescription: '분양 반려동물 목록 조회 성공',
...
export function ApiGetBreederParentPetsEndpoint() {
    return applyDecorators(
        ApiEndpoint({
            ...
            isPublic: true,
            supportsOptionalAuth: true,
            successDescription: '부모 반려동물 목록 조회 성공',
