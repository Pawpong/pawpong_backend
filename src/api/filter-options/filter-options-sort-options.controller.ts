...
export class FilterOptionsSortOptionsController {
    constructor(
        ...
        private readonly filterOptionsSortOptionResponseMessageService: FilterOptionsSortOptionResponseMessageService,
    ) {}
    ...
    async getSortOptions(): Promise<ApiResponseDto<SortOptionDto[]>> {
        ...
        return ApiResponseDto.success(
            result,
            this.filterOptionsSortOptionResponseMessageService.sortOptionsRetrieved(),
        );
    }
}
