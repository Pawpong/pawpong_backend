...
export class FilterOptionsAdoptionStatusController {
    constructor(
        ...
        private readonly filterOptionsAdoptionStatusResponseMessageService: FilterOptionsAdoptionStatusResponseMessageService,
    ) {}
    ...
    async getAdoptionStatus(): Promise<ApiResponseDto<AdoptionStatusOptionDto[]>> {
        ...
        return ApiResponseDto.success(
            result,
            this.filterOptionsAdoptionStatusResponseMessageService.adoptionStatusRetrieved(),
        );
    }
}
