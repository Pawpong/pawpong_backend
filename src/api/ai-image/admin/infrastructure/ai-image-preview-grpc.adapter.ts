...
import { AI_IMAGE_ASSET_URL_PORT } from '../../shared/application/ports/ai-image-asset-url.port';
import type { AiImageAssetUrlPort } from '../../shared/application/ports/ai-image-asset-url.port';
