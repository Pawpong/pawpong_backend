...
import { FeedVideoDetailController } from './controller/feed-video-detail.controller';
import { FeedVideoHlsStreamController } from './controller/feed-video-hls-stream.controller';
import { FeedVideoListController } from './controller/feed-video-list.controller';
import { FeedVideoPrefetchController } from './controller/feed-video-prefetch.controller';
import { FeedVideoPopularController } from './controller/feed-video-popular.controller';
import { FeedVideoUploadController } from './controller/feed-video-upload.controller';
import { FeedVideoViewController } from './controller/feed-video-view.controller';
import { FeedVideoLibraryController } from './controller/feed-video-library.controller';
import { FeedVideoOwnershipController } from './controller/feed-video-ownership.controller';
import { FeedVideoLikeCommandController } from './controller/feed-video-like-command.controller';
import { FeedVideoLikeStatusController } from './controller/feed-video-like-status.controller';
import { FeedVideoLikedVideosController } from './controller/feed-video-liked-videos.controller';
import { FeedVideoCommentQueryController } from './controller/feed-video-comment-query.controller';
import { FeedVideoCommentCreateController } from './controller/feed-video-comment-create.controller';
import { FeedVideoCommentUpdateController } from './controller/feed-video-comment-update.controller';
import { FeedVideoCommentDeleteController } from './controller/feed-video-comment-delete.controller';
import { FeedVideoTagSearchController } from './controller/feed-video-tag-search.controller';
import { FeedVideoTagCatalogController } from './controller/feed-video-tag-catalog.controller';
